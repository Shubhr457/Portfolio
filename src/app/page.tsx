          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-[var(--text-body)]">
                <p>
                  I&apos;m a backend developer with about two years of
                  experience building scalable APIs, data layers, and real-time
                  features in Node.js and TypeScript — from PostgreSQL and
                  Prisma to MongoDB, Mongoose, and Socket.io.
                </p>
                <p>
                  At SoluLab (remote), I was the sole backend engineer on
                  Terrava, a live carbon credit marketplace: 30+ REST endpoints,
                  modular services, soft-delete–friendly schemas, cron jobs, and
                  integrations like BanQu for supply-chain traceability.
                </p>
                <p>
                  I&apos;ve also delivered client backends end to end (e.g.
                  wallet marketplace flows, payment logic, third-party
                  connectors) and keep hands-on with blockchain tooling —
                  Solidity, EVM, and Rust/Anchor on Solana — when products need
                  it.
                </p>
              </div>
              ...
              <div className="mt-8 flex flex-wrap gap-6">
                ...
                <div className="card p-6 flex-1 min-w-[140px]">
                  <div className="text-3xl font-bold gradient-text-alt mb-2">
                    2+
                  </div>
                  <div className="text-sm text-[var(--text-muted)]">
                    Years Experience
              ...
              {formStatus === "sent" ? (
                <div className="flex flex-col items-center justify-center h-full text-center py-8">
                  ...
                  <p className="text-[var(--text-muted)] mb-6">
                    Your email client opened with the message. I&apos;ll get
                    back to you soon.
                  </p>
                  <button
